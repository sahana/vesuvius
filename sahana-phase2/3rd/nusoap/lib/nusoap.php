...
/*
$Id: nusoap.php,v 1.2 2006-07-24 11:58:38 janakawicks Exp $
...
* @version  $Id: nusoap.php,v 1.2 2006-07-24 11:58:38 janakawicks Exp $
* @access   public
*/
class nusoap_base {
	/**
    ...
    */
    function webDescription(){
		...
		<div class=content>
			...
			<div class=nav>
				<p>View the <a href="'.$PHP_SELF.'?mod='.$_GET['mod'].'&act='.$_GET['act'].'&stream=soap'.'&wsdl">WSDL</a> for the service.
