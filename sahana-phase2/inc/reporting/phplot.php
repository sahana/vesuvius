...
/* $Id: phplot.php,v 1.1 2006-06-28 05:18:02 jayasinghe Exp $ */
...
/////////////////////////////////////////////
	...
	//-------------------------------
		...
		global $global;
    		$db=$global["db"];
		//,date_of_created,time_of_created,report_chart_owner,file_type,file_size,keyword,title
		$q="insert into report_files(file_name,file_data) values ('sdtestfile','$data')";
    		$res=$db->Execute($q);
	...
	time_of_created time,
	report_chart_owner varchar(100),
