<%@ page import="org.campdb.util.CAMPDBConstants"%>
...
<body>
 ...
 <table width="100%" border="0" cellspacing="2" cellpadding="0" bgcolor="#D8E9FD">
    ...
    <%
                String errorDescription = (String) request.getSession().getAttribute(CAMPDBConstants.IContextInfoConstants.ERROR_DESCRIPTION);
