...
//    }
    ...
    public static String getSQLForUserCheck(String userName) {
        String s = "SELECT "+ DBConstants.TableColumns.USER_NAME + " FROM " + DBConstants.Tables.USERS + " WHERE "+DBConstants.TableColumns.USER_NAME+"='"+userName+"'";
        return s;
    }
    ...
    */
    ...
    public static String getSQLForOrganizationDistrictInsertion() {
        ...
        return "INSERT into "
            ...
            + DBConstants.Tables.ORGANIZATION_DISTRICT

            + " ("
            + DBConstants.TableColumns.ORGANIZATION_DISTRICT_ORG_CODE + ", "
            + DBConstants.TableColumns.ORGANIZATION_DISTRICT_DISTRICT_NAME
            + ") "
    ...
    public static String getSQLForOrganizationRegistrationUser() {
        return "INSERT into "
