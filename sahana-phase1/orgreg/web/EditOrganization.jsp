...
<%
    ...
    if (request.getParameter("Update") == null) {  //data comes from the database
        ...
        orgReg = dataAccessManager.getOrgTO(orgCode);
...
<%--              <td align="center" vAlign="top" colspan="2" class="formText" ><strong>User Registration</strong></td>--%>
            ...
            <tr>
              <td></td>
              <td>
                <input name="Update" type="submit" value=" Update " class="buttons" >
