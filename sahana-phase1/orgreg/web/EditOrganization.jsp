...
%>
    ...
    <form method="post" name="tsunamiOrgReg" action="EditOrganization.jsp?fromAction=<%=action%>">
...
<%--                                <p>Other Sector : <input style="display.none"  type="formText"  style="width: 100px;" name="inputVal" value=""></p>--%>
                                <p>
                            ...
                            %>
                               <textarea  <%if(globalControlDisable){ %>disabled="true" <%}%> cols="40" readonly="true" name="sectors" rows="4"><%=sectors%></textarea>
                              </tr>
                            </table>
                        </td>
                        </tr>
