...
<form action="/hris/changepasswordservlet" name="frmChangePass" method="post">
<br>
  ...
  <%
     ...
     ChangePasswordBean.setEmpId(LoginBean.getEmpId());
  %>
    <tr>
      ...
      <td width="23%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
        <input type="text" name="empId" id="empId" value="<%=ChangePasswordBean.getEmpId()%>">
        </font></td>
      <td width="30%"></td>
    </tr>
    <tr>
