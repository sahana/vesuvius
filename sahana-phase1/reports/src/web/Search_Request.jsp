...
//	(RequestSearchCriteriaTO) request.getSession().getAttribute(
//		ERMSConstants.IContextInfoConstants.REQUESTSEARCHCRITERIA_DTO);
...
//strsiteArea = request.getParameter("siteArea");
...
//temprequestSearchCriteriaTO.setCallerName((strcallerName!=null && !strcallerName.equals(""))?strcallerName:null);
...
//temprequestSearchCriteriaTO.setSiteArea((strsiteArea != null && !strsiteArea.equals(""))?strsiteArea:null);
...
//requestSearchCriteriaTO.setOrganization(request.getParameter("organization")!=null?request.getParameter("organization"):"");
//TODO: These sections have been disabled because the DB integration has not been finalized
//requestSearchCriteriaTO.setRequestDateTo(
//	new java.sql.Date(request.getParameter("fromDate")));
//requestSearchCriteriaTO.setRequestDateTo(request.getParameter("toDate"));

//String strcallerName = request.getParameter("callerName");
//requestSearchCriteriaTO.setCallerName(strcallerName!=null?strcallerName:"");
...
//requestSearchCriteriaTO.setSiteArea(strsiteArea!=null?strsiteArea:"");
...
<option value="select">&ltselect&gt</option>
...
<!--
												...
												<td colspan="4"><input type="text" name="callerName"
													class="textBox"
													value="<%=requestSearchCriteriaTO.getCallerName()%>"></td>
-->	
											</tr>
											<tr>
												...
												<td colspan="4"><input type="text" name="siteName"
													class="textBox"
													value="<%=requestSearchCriteriaTO.getSiteName()%>"></td>
											</tr>
											<tr>
												<td>&nbsp;</td>
												<td colspan="4">&nbsp;</td>
	...
	out.print("Exception occurd " + e);
		...
		<!--
												...
												<td colspan="4"><input type="text" name="siteArea"
													class="textBox"
													value="<%=requestSearchCriteriaTO.getSiteArea()%>"></td>
		-->
											</tr>
											<tr>
												<td>&nbsp;</td>
...
try {
	...
	<!--
												...
												<td height="25" colspan="4"><select name="status"
													class="textBox"
													value="<%=requestSearchCriteriaTO.getStatus()%>">
												//TODO: Add functionality to retrieve status from the database
		...
		-->
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="22%" align="right"><input type="submit"
													name="cancel" value="Cancel" onclick="resetForm()" class="buttons">&nbsp;</td>
									...
									<tr>
										<td colspan="2">
										<div id="Layer1"
											style="position: auto; left: 150px; top: 279px; width: 100%; height: 200px; z-index: 1; overflow: auto">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr class="formTitle">
												<td class="tableUp">Site Name</td>
												<!-- <td class="tableUp">Site Type</td> -->
...
%>
											<tr>
												<td class="tableDown"><a href="Fulfill_rq.jsp?<%=ERMSConstants.REQUEST_DETAIL_ID + "=" + requestSearchTO.getRequestDetId()%>" style="text-decoration:none"><%=requestSearchTO.getSiteName()!=null?requestSearchTO.getSiteName():""%></a></td>
											<!--	<td class="tableDown"><a href="Fulfill_rq.jsp?<%=ERMSConstants.REQUEST_DETAIL_ID + "=" + requestSearchTO.getRequestDetId()%>" style="text-decoration:none"><%=requestSearchTO.getSiteType()%></a></td> -->
												<td class="tableDown"><a href="Fulfill_rq.jsp?<%=ERMSConstants.REQUEST_DETAIL_ID + "=" + requestSearchTO.getRequestDetId()%>" style="text-decoration:none"><%=requestSearchTO.getSiteDistrict()%></a></td>
												<td class="tableDown"><a href="Fulfill_rq.jsp?<%=ERMSConstants.REQUEST_DETAIL_ID + "=" + requestSearchTO.getRequestDetId()%>" style="text-decoration:none"><%=requestSearchTO.getSiteArea()%></a></td>
												...
												<td class="tableDown"><a href="Fulfill_rq.jsp?<%=ERMSConstants.REQUEST_DETAIL_ID + "=" + requestSearchTO.getRequestDetId()%>" style="text-decoration:none"><%=requestSearchTO.getItem()%></a></td>
						...
						<table width="760" border="0" cellspacing="0" cellpadding="0">
							<tr>
                                <td class="formText" align="center">
                                        <a href="Index.jsp">Request Management Home</a>
                                </td>
                            </tr>
						</table>
						</td>
