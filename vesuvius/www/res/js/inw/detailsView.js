...
var DetailsView =
{
	...
	createInfoTag : function(person) {
		...
		var div = $("<div style='width: 210px;float:left; margin: 5px 5px 5px 5px; font-weight:700' id='" + person.uuid + "'></div>")
					...
					.append("<div id='updated_" + person.uuid + "'style='font-weight:normal'><div style='float: left;width:75px;text-align:right;font-weight:bold;margin-right:5px;'>Updated:</div> "
								+ person.statusSahanaUpdated.substring(0, person.statusSahanaUpdated.lastIndexOf(":"))
								+ person.statusSahanaUpdated.substring(person.statusSahanaUpdated.lastIndexOf(" "), person.statusSahanaUpdated.length)
								+ "</div>");
